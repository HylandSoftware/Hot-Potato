        ...
        stage("Run-Unit-Tests") {
            steps {
                container("builder") {
                    ...
                    sh 'dotnet test ./test/HotPotato.Core.Test/HotPotato.Core.Test.csproj -c Release -p:CollectCoverage=true -p:CoverletOutputFormat=cobertura -p:CoverletOutput=./test/results/ --no-restore --no-build'
