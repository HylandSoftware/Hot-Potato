...
namespace HotPotato.NUnitHelpers
{
	...
	public static class HotPotatoResultConstraintExtensions
	{
		//this class may seem redundant, but it is requried for chaining like Is.Not.ApprovedByHotPotato
		//without it, only Is.ApprovedByHotPotato would function
		public static HotPotatoResultConstraint ApprovedByHotPotato(this ConstraintExpression expression)
		{
			var constraint = new HotPotatoResultConstraint();
