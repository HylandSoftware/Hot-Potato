...
namespace HotPotato.Results
{
    public static class ResultFactory
    {
        ...
        public static HeaderInvalidResult HeaderInvalidResult(string key, string value, List<Validators.ValidationError> errors) => new HeaderInvalidResult(key, value, errors);
        ...
        public static BodyInvalidResult BodyInvalidResult(string content, List<Validators.ValidationError> errors) => new BodyInvalidResult(content, errors);
